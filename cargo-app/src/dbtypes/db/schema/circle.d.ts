...
export declare const circleTypeEnum: import("drizzle-orm/pg-core").PgEnum<[CircleType.Manhattan, CircleType.Euclidean]>;
export declare const circles: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        circleType: import("drizzle-orm/pg-core").PgColumn<{
            ...
            notNull: true;
            hasDefault: true;
            enumValues: [CircleType.Manhattan, CircleType.Euclidean];
            baseColumn: never;
        }, {}, {}>;
    };
    dialect: "pg";
